...
const shortcomingsData = [
  {
    title: "Fixed posture reference",
    desc: "Most devices assume a perfect 'straight' posture that doesn't fit everyone's body type or natural resting position.",
  },
  {
    title: "One-size-fits-all reminders",
    desc: "Generic vibrations can quickly become annoying when they buzz during tasks where leaning is necessary.",
  },
  {
    title: "Limited personalization",
    desc: "Without context, simple sensors cannot distinguish between slouching and leaning forward intentionally.",
  },
  {
    title: "No long-term tracking",
    desc: "Many tools lack the software ecosystem needed to visualize long-term habit changes and improvements.",
  },
];
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 text-center">
        ...
        <div className="flex flex-col lg:flex-row gap-6 lg:gap-8 justify-center">
          ...
          >
            ...
            <p className="text-[#9CA3AF] text-lg leading-relaxed font-light relative z-10">
              Gentle haptic reminders when you deviate from your calibrated posture. Builds long-term awareness and muscle memory.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-[#9CA3AF] text-lg leading-relaxed font-light relative z-10">
              Dedicated sessions of rhythmic, soothing vibrations designed to relax the upper back after long sitting hours.
            </p>
          </motion.div>
        </div>
      </div>
        ...
        <div className="flex flex-col lg:flex-row gap-16 lg:gap-24 items-center">
          ...
          >
            ...
            <div className="flex flex-col gap-6">
              {[
                "Customizable delay before alerts",
                "Multiple saved lifestyle profiles",
                "Adaptive sensing sensitivity",
              ].map((item, i) => (
    ...
    <section className="relative w-full min-h-screen bg-[#0A0D12] text-white overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 text-center">
        ...
        <motion.div
          ...
          className="absolute left-[20%] top-[35%] w-3 h-3 rounded-full bg-cyan-400 blur-sm"
        />
        ...
        <motion.div
          ...
          className="absolute right-[18%] top-[25%] w-2 h-2 rounded-full bg-blue-400 blur-sm"
        />
  ...
  return (
    <section className="relative w-full py-32 lg:py-48 bg-[#0F1115] text-white overflow-hidden flex flex-col items-center">
      ...
      <div className="relative z-10 w-full max-w-4xl mx-auto px-6 text-center flex flex-col items-center">
        ...
        >
          <Link href="/product" className="w-full sm:w-auto btn-primary-dark">
            Explore Product
          </Link>
          <Link href="/contact" className="w-full sm:w-auto btn-secondary-dark">
            Contact Us
          </Link>
        </motion.div>
      </div>
...
export default function WhyAlignPodContent() {
  return (
