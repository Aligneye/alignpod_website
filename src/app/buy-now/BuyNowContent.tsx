...
function BuyNowForm() {
  ...
  const itemLabel = isCollar
    ? `AlignPod Magnetic Collar${itemColor ? ` (${itemColor})` : ""}`
    : "AlignPod";
  ...
  return (
    <section className="max-w-5xl mx-auto">
      ...
      >
        ...
        <h1 className="heading-hero text-[#111111] mb-6">Buy {itemLabel}</h1>
...
export default function BuyNowContent() {
  return (
    <>
      <Navbar />
      <main className="min-h-screen bg-[#F8F8F6] pt-32 pb-24 px-6">
        <Suspense fallback={<div className="max-w-5xl mx-auto text-center py-20 text-gray-400">Loading order form...</div>}>
          <BuyNowForm />
        </Suspense>
      </main>
      <Footer />
