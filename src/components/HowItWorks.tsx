...
export function HowItWorks() {
  return (
    <section
      className="relative w-full py-32 lg:py-12 bg-white selection:bg-[#111111] selection:text-white lg:min-h-screen lg:flex lg:items-center"
      id="how-it-works"
    >
      {/* Background Textures */}
      ...
      <div className="relative z-10 w-full">
        ...
        <motion.div
          ...
          variants={fadeInUp}
          className="max-w-3xl mx-auto text-center mb-24 lg:mb-10 px-6 lg:px-8"
        >
          <span className="inline-block text-xs font-semibold tracking-[0.2em] text-[#6B7280] uppercase mb-6 lg:mb-3">
            How It Works
          </span>
          <h2 className="heading-section text-[#111111] mb-6 lg:mb-3 lg:text-4xl">
            Better posture starts in four simple steps.
          </h2>
          <p className="text-body text-[#6B7280] lg:text-base">
