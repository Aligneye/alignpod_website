      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          ...
          <div className="w-full lg:w-1/3 flex flex-col">
            <Link href="/" className="flex items-center gap-3 mb-6 group transition-opacity hover:opacity-80">
              ...
              <div key={idx} className="flex flex-col">
                ...
                <ul className="flex flex-col gap-4">
                  {column.links.map((link, linkIdx) => {
                    ...
                    const linkClasses =
                      "text-white/60 text-sm hover:text-white transition-colors duration-300 relative group inline-block";
