      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          {contactCards.map((card, idx) => (
            <motion.div key={idx} variants={fadeInUp} className="card-light flex flex-col items-start">
              <div className="icon-box-light">
                <card.icon className="w-6 h-6" strokeWidth={1.5} />
              </div>
              <span className="text-sm font-semibold tracking-wider text-[#6B7280] uppercase mb-2">
                {card.title}
              </span>
              ...
              <button
                ...
                className="group flex items-center gap-2 text-[#111111] font-semibold text-sm hover:text-gray-600 transition-colors cursor-pointer"
              >
                {copiedIndex === idx ? (
                  <>
...
function ContactForm() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const { error } = await supabase.from("contact_us").insert([payload]);
    ...
    <section className="py-24 lg:py-32 bg-white text-[#111111]">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row gap-16 lg:gap-24">
          ...
          >
            <h2 className="heading-section text-[#111111]">How can we help?</h2>
                ...
                {status === "success" ? (
                  ...
                  >
                    ...
                    <div className="flex flex-col w-full gap-4">
                      <button
                        ...
                        className="btn-primary-light w-full cursor-pointer"
                      >
                        Send Another Message
                      </button>
                      <Link href="/" className="btn-secondary-light w-full text-center">
                        Back to Homepage
                      </Link>
                    </div>
                  </motion.div>
                  ...
                  >
                    ...
                    <button
                      ...
                      className="btn-primary-light w-full mt-4 flex justify-center items-center disabled:opacity-70 disabled:cursor-not-allowed cursor-pointer"
                    >
                      {status === "submitting" ? (
                        <motion.div
                          animate={{ rotate: 360 }}
  ...
  return (
    <section className="py-24 lg:py-32 bg-[#F8F8F6] text-[#111111]">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          <h2 className="heading-section text-[#111111]">Stay connected.</h2>
