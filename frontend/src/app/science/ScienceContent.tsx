...
function SmartCalibrationEngine() {
  return (
                  ...
                  <div
                    ...
                    className={`w-full p-4 rounded-2xl border ${
                      idx === 0
                        ...
                        : "bg-[#F8F8F6] text-[#6B7280] border-[#E7E7E7]"
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
        ...
        <div className="relative h-[500px] sm:h-[600px] w-full flex justify-center items-center perspective-[2000px]">
          ...
          >
            ...
            <img
              src={getImgSrc(dayrecord)}
              alt="Daily posture session history in the AlignPod app"
          ...
          >
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-24 h-5 bg-[#E5E7EB] rounded-b-2xl"></div>
            <img
              src={getImgSrc(record)}
              alt="Long-term posture trend record in the AlignPod app"
              className="w-full h-full object-cover"
            />
          </motion.div>
        </div>
